...
// Environment: GH_TOKEN, WIKI_BOT_USER, WIKI_BOT_PASSWORD (the last two not needed with --dry-run)
...
$login = wiki( [
	'action' => 'login', 'lgname' => getenv( 'WIKI_BOT_USER' ), 'lgpassword' => getenv( 'WIKI_BOT_PASSWORD' ), 'lgtoken' => $token,
] )['login'];
